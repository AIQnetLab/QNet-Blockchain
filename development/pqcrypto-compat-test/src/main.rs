/**
 * pqcrypto-dilithium 0.5 self-test + cross-verify against Android pqclean C code
 *
 * ARCHITECTURE:
 *   Android (pqclean C via NDK)  <->  Server (pqcrypto-dilithium 0.5 Rust crate)
 *   Both use PQClean dilithium3 clean reference implementation -> byte-perfect compatibility
 *
...
fn cross_verify_android_pqclean() {
    ...
    print!("Cross-verify Android pqclean C -> Rust pqcrypto-dilithium 0.5: ");
...
fn main() {
    println!("=== pqcrypto-dilithium 0.5 (PQClean dilithium3) self-test + cross-verify ===\n");
    ...
    // ---- Summary ----
    println!("\n=== SUMMARY ===");
    println!("pqcrypto-dilithium 0.5 (PQClean dilithium3): ALL SELF-TESTS PASSED");
    ...
    println!("Rust server : pqcrypto-dilithium 0.5           (CTILDEBYTES=48, SIG=3309B)");
