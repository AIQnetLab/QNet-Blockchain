...
type NodeActivationProps = {
  selectedNodeType: 'light' | 'super';
  setSelectedNodeType: (type: 'light' | 'super') => void;
  getCostRange: (type: 'light' | 'super') => string;
};
    ...
    <div className="explorer-card activation-card" style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="activation-content" style={{ padding: '0.75rem' }}>
        ...
        <div style={{ 
          ...
          {/* Node Type Buttons - v3.18: Only Light and Super */}
          ...
          <div style={{ 
            ...
            <div>
              ...
              {/* Single-line requirements for node types */}
