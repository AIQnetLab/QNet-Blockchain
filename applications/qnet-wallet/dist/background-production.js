...
async function handleMessage(request, sender, sendResponse) {
    try {
        ...
        switch (request.type) {
            ...
            case 'SETUP_COMPLETE':
                try {
                    console.log('✅ Wallet setup completed, opening main wallet...');
                    ...
                    console.error('❌ Failed to open wallet after setup:', error);
            ...
            case 'GET_QNET_DATA':
                try {
                    ...
                    console.error('❌ Failed to get QNet data:', error);
                    return sendResponse({
                        success: false,
            ...
            case 'GET_SOLANA_DATA':
                try {
                    ...
                    console.error('❌ Failed to get Solana data:', error);
                    return sendResponse({
                        success: false,
...
async function getBalance(address, tokenMint = null) {
    try {
        ...
        if (walletState.currentNetwork === 'solana') {
            ...
            console.log(`Balance for ${address} (${tokenMint || 'SOL'}): ${balance}`);
        } else {
