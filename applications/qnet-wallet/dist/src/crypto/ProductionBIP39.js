...
const BIP39_WORDLIST = [
    ...
    'yes', 'yesterday', 'yet', 'yield', 'young', 'yourself', 'youth', 'zone', 'zoo'
];
...
class ProductionBIP39 {
    constructor() {
        ...
        console.log(`BIP39 initialized with ${this.wordlist.length} words`);
    }
    ...
    generateMnemonic(wordCount = 12) {
        ...
        const words = [];
        console.log(`Generating ${wordCount} words from ${this.wordlist.length} word dictionary`);
        ...
        for (let i = 0; i < wordCount; i++) {
            ...
            words.push(word);
            console.log(`Word ${i + 1}: ${word} (index: ${randomIndex})`);
        }
        
        const result = words.join(' ');
        console.log('Generated mnemonic:', result);
        return result;
    }
    ...
    generateBIP39Mnemonic(strength = 128) {
        console.log('Using simplified BIP39 generation (legacy method)');
...
if (typeof window !== 'undefined') {
    ...
    console.log('ProductionBIP39 loaded in browser context');
}
